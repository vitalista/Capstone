window.addEventListener('load', function() {
  document.getElementById('livestock-image').style.backgroundImage = "url('assets1/img/Agri%20Livestock.jpg')";
  document.getElementById('seeds-image').style.backgroundImage = "url('assets1/img/Agri%20seeds.jpg')";
  document.getElementById('cash-assistance-image').style.backgroundImage = "url('assets1/img/Agri%20Cash.jpg')";
  document.getElementById('fertilizer-image').style.backgroundImage = "url('assets1/img/Agri%20Fertilizer.jpg')";
  document.getElementById('machine-distribution-image').style.backgroundImage = "url('assets1/img/Agri%20Machine.jpg')";
});
